...
function startFullCombatWithFood() {
  ...
  // CORRECCIÃ“N: Actualizar el estado del jugador con el resultado final.
...
function handleExportBuild() {
  ...
  html2canvas(cardElement, { 
    ...
    useCORS: true // Para cargar imÃ¡genes externas si las hubiera
  }).then(canvas => {
...
// NUEVA FUNCIÃ“N PARA POBLAR LA TARJETA
function populateExportCard(summary) {
  ...
  // --- 3. POBLAR EQUIPO (sin cambios en esta secciÃ³n) ---
...
async function initialize() {
  ...
  // CORRECCIÃ“N: Se asocia el botÃ³n a la funciÃ³n correcta y se elimina el listener duplicado.
